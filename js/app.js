...
var invariant = __webpack_require__(15);
var canUseDOM = __webpack_require__(45);
...
var ContextWrapper = __webpack_require__(191);
var assign = __webpack_require__(26);
...
exports.DefaultRoute = __webpack_require__(95);
exports.Link = __webpack_require__(192);
exports.NotFoundRoute = __webpack_require__(97);
exports.Redirect = __webpack_require__(98);
exports.Route = __webpack_require__(44);
exports.ActiveHandler = __webpack_require__(43);
exports.RouteHandler = exports.ActiveHandler;

exports.HashLocation = __webpack_require__(99);
exports.HistoryLocation = __webpack_require__(70);
...
exports.ImitateBrowserBehavior = __webpack_require__(102);
...
exports.createRoutesFromReactChildren = __webpack_require__(103);

exports.create = __webpack_require__(104);
...
var LocationActions = __webpack_require__(34);
...
var HistoryLocation = __webpack_require__(70);
var History = __webpack_require__(27);
...
var assign = __webpack_require__(26);
var warning = __webpack_require__(68);
var DefaultRoute = __webpack_require__(95);
var NotFoundRoute = __webpack_require__(97);
...
var canUseDOM = __webpack_require__(45);
var LocationActions = __webpack_require__(34);
var ImitateBrowserBehavior = __webpack_require__(102);
var HashLocation = __webpack_require__(99);
var HistoryLocation = __webpack_require__(70);
var RefreshLocation = __webpack_require__(100);
var StaticLocation = __webpack_require__(101);
var ScrollHistory = __webpack_require__(197);
var createRoutesFromReactChildren = __webpack_require__(103);
var isReactChildren = __webpack_require__(199);
var Transition = __webpack_require__(200);
var PropTypes = __webpack_require__(14);
var Redirect = __webpack_require__(106);
var History = __webpack_require__(27);
var Cancellation = __webpack_require__(105);
...
var _es6PromisePolyfill = __webpack_require__(108);

var _es6PromisePolyfill2 = _interopRequireDefault(_es6PromisePolyfill);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var API_KEY = "AIzaSyBeQKxCMRExRShOClX1Ei1VFdjdUI7wX98";
var GOOGLE_SEARCH_ENGINE_ID = "013521578711198445725:wxlfdxdhixc";

var _request = {
  // http get request
  ajaxGet: function ajaxGet(url) {
    return new _es6PromisePolyfill2.default.Promise(function (resolve, reject) {
...
var Api = {
  getImages: function getImages(keyword) {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(71), __webpack_require__(205).setImmediate))
...
var Enum = function () {
	function Enum(_ordinal, _name, _value) {
	...
	_createClass(Enum, [{
		...
		key: "build",
		value: function build(EnumClass, enumDefs) {
			var curEnum,
			    curName,
			    curOrdinal = 0,
			    curValue,
...
var _isIE = function _isIE(userAgent) {
...
var routes = _react2.default.createElement(
  ...
  _react2.default.createElement(Route, { name: _page2.default.ABOUT.getValue(), handler: _about2.default })
);
...
var ReactDOMIDOperations = __webpack_require__(77);
var ReactDOMIframe = __webpack_require__(155);
...
var AutoFocusMixin = __webpack_require__(42);
var ReactBrowserComponentMixin = __webpack_require__(13);
var ReactClass = __webpack_require__(8);
var ReactElement = __webpack_require__(3);
...
var EventConstants = __webpack_require__(7);
var LocalEventTrapMixin = __webpack_require__(64);
var ReactBrowserComponentMixin = __webpack_require__(13);
var ReactClass = __webpack_require__(8);
var ReactElement = __webpack_require__(3);
...
var invariant = __webpack_require__(15);
var canUseDOM = __webpack_require__(45);
var getWindowScrollPosition = __webpack_require__(198);
...
var createRouter = __webpack_require__(104);
...
var _imageStore = __webpack_require__(208);
...
var _imagesGrid = __webpack_require__(210);
...
var Home = function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    value: function componentWillMount() {
      ...
      _imageStore2.default.getData().then(function (data) {
        _this2.setState({
          images: data
        });
      });
    ...
    key: 'render',
    value: function render() {
      var content = _react2.default.createElement(_loading2.default, null);

      if (this.state.images) {
        content = _react2.default.createElement(_imagesGrid2.default, { images: this.state.images });
      }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'label',
          null,
          'Google Image Search, grid layout, lightbox app.'
        ),
        content
      );
    }
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(71), __webpack_require__(0)))
...
var SEARCH_TERMS = ["goal", "leadership", "direction"];
  ...
  getData: function getData() {
    return new _es6PromisePolyfill2.default.Promise(function (resolve, reject) {
      if (_data.images.length) {
        ...
        SEARCH_TERMS.forEach(function (keyword, index) {
          _api2.default.getImages(keyword).then(function (data) {
...
var _lightbox = __webpack_require__(211);
...
var ImagesGrid = function (_React$Component) {
  _inherits(ImagesGrid, _React$Component);
  ...
  function ImagesGrid() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ImagesGrid.__proto__ || Object.getPrototypeOf(ImagesGrid)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
  ...
  _createClass(ImagesGrid, [{
    ...
    value: function render() {
      ...
      this.props.images.forEach(function (item, index) {
        // create click callback
        clickEvent = _this2._openLightbox.bind(_this2, index);

        images.push(_react2.default.createElement(
          'li',
          { title: item.title, onClick: clickEvent },
          _react2.default.createElement('img', { src: item.link })
        ));
      });

      if (this.state.lightboxShowing) {
        lightboxComp = _react2.default.createElement(_lightbox2.default, {
    ...
    key: '_openLightbox',
    value: function _openLightbox(index) {
      this.setState({
...
var _direction = __webpack_require__(212);
...
var Lightbox = function (_React$Component) {
  ...
  _createClass(Lightbox, [{
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'a',
              { className: 'modal-close', onClick: this.props.onClose },
              _react2.default.createElement(_icon2.default, { iconName: 'close', alt: 'X' })
            )
          ),
          _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'a',
                { className: 'left', onClick: this._onNavigate.bind(this, _direction2.default.PREV) },
                _react2.default.createElement(_icon2.default, { iconName: 'chevronleft', alt: '<' })
              )
            ),
            _react2.default.createElement('img', { src: selectedImg.link }),
            _react2.default.createElement(
              'div',
              { className: 'nav' },
              _react2.default.createElement(
                'a',
                { className: 'right', onClick: this._onNavigate.bind(this, _direction2.default.NEXT) },
                _react2.default.createElement(_icon2.default, { iconName: 'chevronright', alt: '>' })
              )
            )
          ),
          _react2.default.createElement(
    ...
    key: '_onNavigate',
    value: function _onNavigate(direction) {
      var currentIndex = this.state.selectedIndex;

      switch (direction) {
        case _direction2.default.PREV:
          currentIndex--;
          break;
        case _direction2.default.NEXT:
          currentIndex++;
          break;
      }
...
var Direction = function (_Enum) {
  _inherits(Direction, _Enum);
...
var Footer = function (_React$Component) {
  ...
  _createClass(Footer, [{
    key: 'buildGitBtn',
    value: function buildGitBtn(type) {
      ...
      return _react2.default.createElement('iframe', { src: src, frameborder: '0', scrolling: '0', width: width, height: '20px' });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      this.props.git.btnTypes.forEach(function (type, index) {
        gitBtns.push(_this2.buildGitBtn(type));
      });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'a',
            { href: 'https://github.com/chaozhang/', target: '_blank' },
            'Chao Zhang'
          ),
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            Link,
            { id: 'logo', to: '/' },
            _react2.default.createElement(_icon2.default, { iconName: 'home', alt: 'Home' })
          ),
          _react2.default.createElement(
            'div',
            { className: 'links' },
            ...
            _react2.default.createElement(
              'a',
              { href: this.props.issues, target: '_blank' },
              'Submit Feedback'
            )
          )
        )
...
var Header = function (_React$Component) {
  ...
  _createClass(Header, [{
    ...
    value: function getNavItems() {
      ...
      this.props.navItems.forEach(function (itemData, index) {
...
var Page = function (_Enum) {
	_inherits(Page, _Enum);
